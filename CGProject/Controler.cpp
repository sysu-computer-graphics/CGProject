...
bool Controler::init(const int scr_width, const int scr_height)
{
	...
	// 窗口的宽和高作为它的前两个参�? 第三个参数表示这个窗口的名称（标题）
